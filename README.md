...
* **The Ringbearer's Vow: The Halfling**
  ...
  * **Criteria:**
    ...
    * **Race Requirement:** You must play a Gnome.
    * You must fish up and equip **The 1 Ring**.
    * You cannot use the Stealth ability unless **The 1 Ring** is actively equipped.
    * **The Burden:** Equipping or carrying the Ring slowly builds Corruption. Reaching 100% Corruption fails the challenge. (Resting at an Inn or near a Campfire reduces your Corruption).
    * You may only equip a One-Handed Sword or Dagger in your main hand.
    * No Dual Wielding: Your off-hand must remain empty or hold a non-weapon frill.
    * At Level 60, you must carry the Ring to the forge inside Blackrock Mountain and cast it into the fire.
...
2. Unzip the package.
3. Copy the `Purity` folder into your `World of Warcraft/\\\_retail\\\_/Interface/AddOns/` (or `\\\_classic\\\_` / `\\\_classic\\\_era\\\_`) directory depending on your game version.
