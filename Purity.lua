...
local function ShouldSuppressPopup(which)
    ...
    if upper == "CONFIRM_SUMMON" then
        return false
    end
    
    return upper:find("RESURRECT") or upper:find("REVIVE") or upper:find("CORPSE") or upper:find("XP_LOSS") or upper:find("RELEASE")
end
